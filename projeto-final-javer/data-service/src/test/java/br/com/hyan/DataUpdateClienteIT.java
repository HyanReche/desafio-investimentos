...
class DataUpdateClienteIT {
	
	@Autowired
	WebTestClient testClient;
	
	@Test
	public void updateCliente_ComIdExistente_ReturnClienteStatus200() {
		DataDto dataDto = new DataDto("Hyan Reche ALTERADO", "11951446751", 500.0f, null, null);
	...
	@Test
	public void updateCliente_ComIdInexistente_ReturnErrorMessageComStatus404() {
		DataDto dataDto = new DataDto("Hyan Reche ALTERADO", "11951446751", 500.0f, null, null);
		testClient
				.put()
				.uri("/clientes/30")
	...
	public void updateCliente_ComDadosValidos_ReturnUsuarioCriadoComStatus200() {
		...
		DataDto dataDto2 = new DataDto("Hyan Reche ALTERADO", "11951446751", null, null, null);
		...
		org.assertj.core.api.Assertions.assertThat(responseBody2.getNome()).isEqualTo("Hyan Reche ALTERADO");
		org.assertj.core.api.Assertions.assertThat(responseBody2.getTelefone()).isEqualTo("11951446751");
		org.assertj.core.api.Assertions.assertThat(responseBody2.getCorrentista()).isEqualTo(true);
		org.assertj.core.api.Assertions.assertThat(responseBody2.getSaldo_cc()).isEqualTo(3200.0f);
		org.assertj.core.api.Assertions.assertThat(responseBody2.getScore_credito()).isEqualTo(320.0f);
		
		//Saldo conta corrente como 0.0
		DataDto dataDto3 = new DataDto("Hyan Reche ALTERADO", "11951446751", 0.0f, null, null);
		...
		org.assertj.core.api.Assertions.assertThat(responseBody3.getNome()).isEqualTo("Hyan Reche ALTERADO");
		...
		DataDto dataDto4 = new DataDto("Hyan Reche ALTERADO", "11951446751", null, null, null);
		...
		org.assertj.core.api.Assertions.assertThat(responseBody4.getNome()).isEqualTo("Hyan Reche ALTERADO");
